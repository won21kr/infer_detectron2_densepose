...
# --------------------
class Detectron2_DensePoseParam(core.CProtocolTaskParam):
...
# --------------------
class Detectron2_DensePoseProcess(dataprocess.CImageProcess2d):
...
# --------------------
class Detectron2_DensePoseProcessFactory(dataprocess.CProcessFactory):
